 ...
 */
package com.example.bootdroolssudoku.model;
...
//        dumpGrid();
    ...
    public void setCellValues(Integer[][] cellValues) {
        ...
        this.session.setGlobal("explain", explain);
	 ...
	 * 
	 * public void objectInserted(ObjectInsertedEvent ev) { if (ev.getObject()
	 * instanceof Counter) { fireRestartEvent(null); } }
	 * 
	 * public void objectDeleted(ObjectDeletedEvent ev) { }
	 * 
	 * public void objectUpdated(ObjectUpdatedEvent ev) { if (ev.getObject()
	 * instanceof Cell) { Cell cell = (Cell) ev.getObject(); if (cell.getValue() !=
	 * null) { fireCellUpdatedEvent(new SudokuGridEvent(this, cell.getRowNo(),
	 * cell.getColNo(), cell.getValue())); } } } }
	 */
